...
//
//        VehicleRoute rottamezzo = new VehicleRoute();
//        rottamezzo.setActualTime(28);
//        rottamezzo.setRoute(route1);
//        rottamezzo.setVehicle(b2);
//
//        vehicleRouteDAO.save(rottamezzo);
//
...
//
//
        //4)CONTROLLARE ABBONAMENTI PER DATA
//        User u2 = new User();
//        u2.setFirstName("Pippo");
//        u2.setLastName("Pluto");
//        try {
//            u2.setDateOfBirth(LocalDate.of(1992,5,30));
//        } catch (DateOfBirthException e) {
//            System.out.println(e.getMessage());
//        }
//
...
//        ms2.setCard(c2);
//        ms2.setDateOfIssue(LocalDate.of(2024, 4,2));
...
//        System.out.println( membershipDAO.checkMembership(UUID.fromString("9ba378bb-a960-4a0d-9407-401e0b42dea7")));
